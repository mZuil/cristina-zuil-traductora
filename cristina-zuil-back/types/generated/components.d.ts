...
export interface ComponentsCHeading extends Struct.ComponentSchema {
  ...
  attributes: {
    hasContactButton: Schema.Attribute.Boolean &
...
export interface ComponentsCModel extends Struct.ComponentSchema {
  collectionName: 'components_components_c_models';
  info: {
    displayName: 'CModel';
    icon: 'code';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'components.c-model': ComponentsCModel;
